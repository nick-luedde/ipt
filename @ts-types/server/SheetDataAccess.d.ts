interface ISheetDataAccess {
  new(source: { id: string, ss: GoogleAppsScript.Spreadsheet.Spreadsheet }, options: { schemas?: object });
  spreadhseet: GoogleAppsScript.Spreadsheet.Spreadsheet;
...
interface ISheetDataCollection<Type> {
  new(sheet: GoogleAppsScript.Spreadsheet.Sheet, options: { schema?: object });
